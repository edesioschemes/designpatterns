...
public class SuvCarBuilder implements Builder {
	...
	public SuvCarBuilder(String carBrand, String engine, Integer numberSeats ) {
	...
	public CarProduct build() {
		return new CarProduct(carBrand, engine, numberSeats, numberAirBags, abs, modelGps, offRoadPackage);
	}
